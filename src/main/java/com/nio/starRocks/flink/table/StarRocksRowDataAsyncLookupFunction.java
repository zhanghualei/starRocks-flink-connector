...
import com.nio.starRocks.flink.lookup.StarRocksJdbcLookupReader;
import com.nio.starRocks.flink.lookup.StarRocksLookupReader;
import com.nio.starRocks.flink.lookup.LookupSchema;
...
public class StarRocksRowDataAsyncLookupFunction extends AsyncTableFunction<RowData> {
    private static final Logger LOG = LoggerFactory.getLogger(StarRocksRowDataAsyncLookupFunction.class);
    private final StarRocksOptions options;
    private final StarRocksLookupOptions lookupOptions;
    private final long cacheMaxSize;
    private final long cacheExpireMs;
    private transient Cache<RowData, List<RowData>> cache;
    private StarRocksLookupReader lookupReader;
    private LookupSchema lookupSchema;

    public StarRocksRowDataAsyncLookupFunction(StarRocksOptions options,
    ...
    public void open(FunctionContext context) throws Exception {
        ...
        this.cache = cacheMaxSize == -1 || cacheExpireMs == -1
                ...
                .build();
        this.lookupReader = new StarRocksJdbcLookupReader(options, lookupOptions, lookupSchema);
    }
