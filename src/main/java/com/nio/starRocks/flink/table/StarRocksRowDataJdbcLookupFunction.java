 ...
 * use jdbc to query
 */
public class StarRocksRowDataJdbcLookupFunction extends TableFunction<RowData> {
    private static final Logger LOG = LoggerFactory.getLogger(StarRocksRowDataJdbcLookupFunction.class);
    ...
    public StarRocksRowDataJdbcLookupFunction(StarRocksOptions options,
