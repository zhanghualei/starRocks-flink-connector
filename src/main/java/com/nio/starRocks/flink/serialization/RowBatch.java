...
package com.nio.starRocks.flink.serialization;
...
public class RowBatch {
        ...
        try {
            ...
            while (arrowStreamReader.loadNextBatch()) {
                ...
                if (fieldVectors.size() != schema.size()) {
                    ...
                    throw new StarRocksException("Load Doris data failed, schema size of fetch data is wrong.");
                }
            ...
            throw new StarRocksRuntimeException(e.getMessage());
        } finally {
            close();
        }
    }
    ...
    private boolean doConvert(int col,
                              ...
                              String currentType,
                              FieldVector fieldVector) throws StarRocksException {
        switch (currentType) {
            case "NULL_TYPE":
                break;
            case "BOOLEAN":
