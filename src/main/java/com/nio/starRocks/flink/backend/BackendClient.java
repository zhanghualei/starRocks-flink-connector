...
package com.nio.starRocks.flink.backend;
...
public class BackendClient {
    ...
    public BackendClient(Routing routing, StarRocksReadOptions readOptions) {
        this.routing = routing;
        this.connectTimeout = readOptions.getRequestConnectTimeoutMs() == null ? ConfigurationOptions.STARROCKS_REQUEST_CONNECT_TIMEOUT_MS_DEFAULT : readOptions.getRequestConnectTimeoutMs();
        this.socketTimeout = readOptions.getRequestReadTimeoutMs() == null ? ConfigurationOptions.STARROCKS_REQUEST_READ_TIMEOUT_MS_DEFAULT : readOptions.getRequestReadTimeoutMs();
        this.retries = readOptions.getRequestRetries() == null ? ConfigurationOptions.STARROCKS_REQUEST_RETRIES_DEFAULT : readOptions.getRequestRetries();
