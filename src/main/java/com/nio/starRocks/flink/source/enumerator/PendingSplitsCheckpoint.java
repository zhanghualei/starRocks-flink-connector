...
public class PendingSplitsCheckpoint {
     ...
     */
    private final Collection<StarRocksSourceSplit> splits;
    ...
    public PendingSplitsCheckpoint(Collection<StarRocksSourceSplit> splits) {
        this.splits = splits;
    }

    public Collection<StarRocksSourceSplit> getSplits() {
        return splits;
    }
}
