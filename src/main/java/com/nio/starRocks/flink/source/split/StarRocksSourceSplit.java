...
public class StarRocksSourceSplit implements SourceSplit {
     ...
     * repeated serialization cheap. This field is used by {@link StarRocksSourceSplitSerializer}.
     */
    @Nullable
    transient byte[] serializedFormCache;

    public StarRocksSourceSplit(PartitionDefinition partitionDefinition) {
    ...
    public String toString() {
        return String.format("StarRocksSourceSplit: %s.%s,be=%s,tablets=%s",
    ...
    public boolean equals(Object o) {
        ...
        StarRocksSourceSplit that = (StarRocksSourceSplit) o;
