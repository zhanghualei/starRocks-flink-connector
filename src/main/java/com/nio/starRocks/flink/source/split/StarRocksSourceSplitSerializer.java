...
/**
 * A serializer for the {@link StarRocksSourceSplit}.
 **/
public class StarRocksSourceSplitSerializer
        implements SimpleVersionedSerializer<StarRocksSourceSplit> {
    ...
    private StarRocksSourceSplit deserialize(byte[] serialized) throws IOException {
        ...
        return new StarRocksSourceSplit(partDef);
    }
}
