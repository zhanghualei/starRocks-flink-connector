 ...
 * Doris read Options
 */
public class StarRocksReadOptions implements Serializable {
    ...
    public StarRocksReadOptions(String readFields, String filterQuery, Integer requestTabletSize, Integer requestConnectTimeoutMs, Integer requestReadTimeoutMs,
    ...
    public static StarRocksReadOptions defaults() {
        return StarRocksReadOptions.builder().build();
    }

    /**
     * Builder of {@link StarRocksReadOptions}.
     */
    public static class Builder {
        ...
        public StarRocksReadOptions build() {
            return new StarRocksReadOptions(readFields, filterQuery, requestTabletSize, requestConnectTimeoutMs,
