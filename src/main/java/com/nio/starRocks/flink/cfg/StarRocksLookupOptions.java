...
public class StarRocksLookupOptions implements Serializable {
    ...
    /** Builder of {@link StarRocksLookupOptions}. */
    public static class Builder {
        ...
        public StarRocksLookupOptions build() {
            return new StarRocksLookupOptions(
                    cacheMaxSize,
                    cacheExpireMs,
                    maxRetryTimes,
                    jdbcReadBatchSize,
