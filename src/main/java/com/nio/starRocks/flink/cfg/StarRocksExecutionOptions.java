...
/**
 * StarRocks sink batch options.
 */
public class StarRocksExecutionOptions implements Serializable {
    ...
    public StarRocksExecutionOptions(int checkInterval,
                                 int maxRetries,
                                 int bufferSize,
                                 int bufferCount,
                                 String labelPrefix,
    ...
    public static StarRocksExecutionOptions defaults() {
        Properties properties = new Properties();
        properties.setProperty("format", "json");
        properties.setProperty("read_json_by_line", "true");
    ...
    /**
     * Builder of {@link StarRocksExecutionOptions}.
     */
    public static class Builder {
        ...
        public StarRocksExecutionOptions build() {
            return new StarRocksExecutionOptions(checkInterval, maxRetries, bufferSize, bufferCount, labelPrefix,
