...
package com.nio.starRocks.flink.util;
...
public abstract class ErrorMessages {
    ...
    public static final String STARROCKS_INTERNAL_FAIL_MESSAGE = "StarRocks server '{}' internal failed, status is '{}', error message is '{}'";
}
