...
// under the License.
package com.nio.starRocks.flink.deserialization.converter;
...
public class StarRocksRowConverter implements Serializable {
    ...
    public StarRocksRowConverter(){}

    public StarRocksRowConverter(RowType rowType) {
    ...
    public StarRocksRowConverter(DataType[] dataTypes) {
    ...
    public StarRocksRowConverter setExternalConverter(DataType[] dataTypes) {
        checkNotNull(dataTypes);
        this.serializationConverters = new SerializationConverter[dataTypes.length];
        for (int i = 0; i < dataTypes.length; i++) {
            LogicalType logicalType = dataTypes[i].getLogicalType();
    ...
    /** Runtime converter to convert starRocks field to {@link RowData} type object. */
    @FunctionalInterface
    interface DeserializationConverter extends Serializable {
        /**
         * Convert a starRocks field object of {@link RowBatch } to the  data structure object.
         *
         * @param field
         */
    ...
    /**
     * Runtime converter to convert {@link RowData} type object to starRocks field.
     */
    @FunctionalInterface
